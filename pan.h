...
#define PanSource	"parallelSwap.pml"
...
#define nstates1	46	/* :init: */
#define minseq1	25
#define maxseq1	69
#define endstate1	45

#define nstates0	26	/* swap */
#define minseq0	0
#define maxseq0	24
#define endstate0	25
...
#define Pswap	((P0 *)this)
typedef struct P0 { /* swap */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define Air0	(sizeof(P0) - Offsetof(P0, temp) - 1*sizeof(int))
